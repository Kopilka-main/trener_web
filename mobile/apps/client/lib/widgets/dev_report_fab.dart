...
/// Оверлей поверх всего приложения: если клиент включил «режим разработчика»
/// в «Помощь с приложением» — рисуем перетаскиваемую кнопку «Сообщить о
/// проблеме» в нижнем ЛЕВОМ углу. Тап → экран поддержки. Ставится в
/// MaterialApp.builder рядом с остальными оверлеями.
