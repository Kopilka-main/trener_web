...
/// Редактирование профиля клиента: имя, дата рождения, био, контакты, аватар.
/// Зеркало веб-клиент ProfilePage.
...
class _ProfileEditScreenState extends ConsumerState<ProfileEditScreen> {
  ...
  void initState() {
    ...
    _birth = a.birthDate != null ? DateTime.tryParse(a.birthDate!) : null;
  ...
  Future<void> _pickAvatar() async {
    ...
    try {
      final ClientAccount a = await ref.read(clientApiProvider).uploadAvatar(picked.path, picked.name);
