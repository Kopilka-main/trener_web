...
/// Гейт обязательного дня рождения: если тренер авторизован, но день рождения
/// не указан — поверх всего приложения показываем обязательный экран ввода
/// (день+месяц, без года). Ставится в MaterialApp.builder.
...
class _BirthdaySetupState extends ConsumerState<_BirthdaySetup> {
  ...
  Future<void> _save() async {
    ...
    try {
      await ref.read(trainerApiProvider).updateProfile(<String, dynamic>{'birthDate': _iso});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('День и месяц. Год указывать не нужно.',
