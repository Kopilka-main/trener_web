...
<body>
  ...
  <ul>
    ...
    <li><b>Аналитика использования:</b> какие экраны Приложения открываются и как долго, версия приложения и платформа,
      идентификатор сессии — в обезличенном виде, для улучшения и стабильности Приложения.</li>
    <li><b>Обращения в поддержку:</b> текст вашего сообщения в поддержку, а также имя и email аккаунта — чтобы мы могли ответить.</li>
  </ul>
  ...
  <ul>
    ...
    <li>анализ использования Приложения (какие функции востребованы) для его улучшения;</li>
    <li>обработка обращений в поддержку и ответы на них;</li>
  ...
  <ul>
    ...
    <li><b>Telegram</b> — при обращении в поддержку текст вашего сообщения передаётся в служебный чат поддержки в Telegram,
      чтобы наша команда могла ответить;</li>
  </ul>
